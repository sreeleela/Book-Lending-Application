 ...
 */
@WebServlet("/ApprovalRequestController")
public class ApprovalRequestController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
				...
				try {
					books = bookLendingApplicationDAO.requestForApproval(username);
				...
				requestDispatcher = request.getRequestDispatcher("/requestsApprovals.jsp");
