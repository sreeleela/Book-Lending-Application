...
/**
 * Servlet implementation class RejectRequestController
 */
@WebServlet("/RejectRequestController")
public class RejectRequestController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean check = false;
		try {
			check = bookLendingApplicationDAO.rejectRequest(requestId,bookId);
		...
		if(check == true) {
			...
			response.setContentType("text/plain");
			response.getWriter().write("Error in Request Rejecting");
		}
	}
